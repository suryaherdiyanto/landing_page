            ...
            <div class="container h-100">
                <div class="row justify-content-between h-100">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-5 d-flex align-items-center justify-content-end h-100">
                        ...
                        <span class="ml-3">
                            <a href="#">
                                <i class="fas fa-comment-alt mr-1"></i> Live Chat
                            </a>
                        </span>
                        <span class="ml-3">
                            <a href="#">
                                <i class="fas fa-user-circle mr-1"></i> Member Area
                            </a>
                        </span>
                    </div>
                </div>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light bg-none">
                    <a class="navbar-brand" href="#">
                        <img src="/assets/images/logo-niagahoster.png" width="220" alt="Main Logo">
                    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="tagline">
                        <h1 class="tagline__title">PHP Hosting</h1>
                        ...
                        <ul class="list-features">
                            ...
                            <li>
                                <i class="fas fa-check-circle"></i> Konsumsi memory yang lebih rendah.
                            </li>
                            <li>
                                <i class="fas fa-check-circle"></i> Support PHP 5.3, PHP 5.4, PHP 5.5, PHP 5.6, PHP 7.
                            </li>
                            <li>
                                <i class="fas fa-check-circle"></i> Fitur enkripsi IonCube dan Zend Guard Loaders.
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 d-flex align-items-center">
                    <img src="/assets/svg/illustration banner PHP hosting-01.svg" alt="" class="img img-fluid">
                </div>
            </div>
        </div>
    </section>
